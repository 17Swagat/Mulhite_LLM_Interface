    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col gap-8 sm:gap-12 md:gap-16 lg:gap-20 items-center">
            <div className="text-white justify-center items-center p-4 sm:p-6 md:p-8 mb-8 sm:mb-12 md:mb-16 bg-linear-to-r bg-green-500 via-purple-500 from-red-500 rounded-2xl sm:rounded-3xl shadow-2xl w-full">
              <h3 className="text-xl sm:text-2xl md:text-3xl text-white font-bold mb-3 sm:mb-4 leading-relaxed">
                Support for Multiple LLMs
              </h3>
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl mb-4 sm:mb-6 max-w-3xl mx-auto font-semibold px-2">
                Simply put your{" "}
              ...
              {/* Infinite - Scrolls */}
              <div className="flex bg-gray-200 overflow-hidden p-1.5 sm:p-2 rounded-xl sm:rounded-2xl">
                <ul className="flex space-x-8 sm:space-x-12 md:space-x-16 animate-infinite-scroll max-w-3xl p-1.5 sm:p-2">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-5xl mx-auto">
            <div className="bg-gray-50 p-4 sm:p-6 rounded-lg shadow-sm text-center">
              ...
              <p className="text-3xl sm:text-4xl font-bold text-gray-900 mb-3 sm:mb-4">Free</p>
              ...
              <p className="text-sm sm:text-base text-gray-500 mt-3 sm:mt-4">Free. No subscription</p>
            </div>
            <div className="bg-gray-50 p-4 sm:p-6 rounded-lg shadow-sm text-center">
              <h3 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-3 sm:mb-4">
                Premium Plan
              ...
              <p className="text-3xl sm:text-4xl font-bold text-gray-900 mb-3 sm:mb-4">
                $5 <span className="text-base sm:text-lg font-normal">USD / Month</span>
              </p>
              <ul className="text-sm sm:text-base text-gray-600 space-y-2 mb-4 sm:mb-6">
              ...
              <p className="text-sm sm:text-base text-gray-500 mt-3 sm:mt-4">Billed Monthly</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-gray-800 text-white py-6 sm:py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-sm sm:text-base">&copy; 2025 ProjectPlannerAI. All rights reserved.</p>
        </div>
      </footer>
    </>
    // </div>
