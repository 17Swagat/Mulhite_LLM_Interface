...
const HIGHLIGHT_COLORS = [
  { name: "Yellow", value: "yellow", bg: "bg-yellow-200", hover: "hover:bg-yellow-300" },
  { name: "Red", value: "red", bg: "bg-red-200", hover: "hover:bg-red-300" },
  { name: "Blue", value: "blue", bg: "bg-blue-200", hover: "hover:bg-blue-300" },
  { name: "Purple", value: "purple", bg: "bg-purple-200", hover: "hover:bg-purple-300" },
  { name: "Pink", value: "pink", bg: "bg-pink-200", hover: "hover:bg-pink-300" },
  { name: "Green", value: "green", bg: "bg-green-200", hover: "hover:bg-green-300" },
  { name: "Orange", value: "orange", bg: "bg-orange-200", hover: "hover:bg-orange-300" },
];
...
export function ToolbarOnTextHighlight({
  ...
  const currentColorObj = HIGHLIGHT_COLORS.find(c => c.value === selectedColor);

  if (!selectedTextRect) return null;

  return (
    <div
      className="fixed z-50 flex items-center gap-1 p-1 rounded-full bg-white/95 shadow-lg backdrop-blur-sm border border-gray-200"
      style={{
    ...
    >
      ...
      >
        <HighlighterIcon size={16} className="text-gray-700" />
              ...
              >
                <div
                  className={`w-4 h-4 rounded-full ${color.bg} border-2 ${
                    selectedColor === color.value ? "border-gray-400 ring-2 ring-gray-300" : "border-gray-300"
                  }`}
                />
