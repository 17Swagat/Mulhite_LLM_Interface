...
//   // Convert \\[ ... \\] or \[ ... \] → $$ ... $$
//   normalized = normalized.replace(/\\\\?\[(.*?)\\\\?\]/gs, (_, content) => {
//     return `$$${content.trim()}$$`;
//   });
...
//   // Handle malformed / incomplete math blocks (avoid breaking UI)
//   // If an unmatched opening \[ or \( exists without closing pair, remove the trailing piece.
//   normalized = normalized.replace(/(\\\[|\\\()/g, match => {
//     // if we don't have corresponding closing \] or \), drop the opening sequence
//     const closing = match === '\\[' ? '\\]' : '\\)';
...
//           rehypePlugins={[rehypeKatex]}
//           remarkPlugins={[remarkGfm, remarkMath, ]} 
//           // remarkPlugins={[remarkGfm, [remarkMath, { singleDollarTextMath: false }]]} // *modified 😑
//           {...options}
//         >
//           {parsedChildren}
//         </HardenedMarkdown>
